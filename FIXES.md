...
- [x] **10. `src/app/error.tsx` (new file) — add a global error boundary that renders a friendly message and a "Go back" link instead of the raw Next.js error page when a server component throws**
